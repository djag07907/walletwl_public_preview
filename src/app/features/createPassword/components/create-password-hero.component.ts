...
@Component({
  selector: "app-create-password-hero",
  standalone: true,
  imports: [
    CommonModule,
    PackageIconComponent,
    ...
    >
        ...
        <div class="space-y-6">
          <div>
            <h1 class="text-5xl font-bold text-white leading-tight">
              {{ t.t("hero.create_password.title_line1") }}<br />
              {{ t.t("hero.create_password.title_line2") }}
            </h1>
            <p class="text-xl text-blue-100">
              {{ t.t("hero.create_password.subtitle") }}
            </p>
          </div>
          ...
          <div class="pt-8 space-y-6">
            <div class="flex items-start gap-4">
              ...
              >
                <icon-lock size="1.5rem" color="white"></icon-lock>
              </div>
              <div>
                <h3 class="text-lg font-semibold text-white mb-1">
                  {{ t.t("hero.create_password.feature1_title") }}
                </h3>
                <ul class="text-blue-100 space-y-1 text-sm">
                  <li>
                    • {{ t.t("hero.create_password.feature1_requirement1") }}
                  </li>
                  <li>
                    • {{ t.t("hero.create_password.feature1_requirement2") }}
                  </li>
                  <li>
                    • {{ t.t("hero.create_password.feature1_requirement3") }}
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                <h3 class="text-lg font-semibold text-white mb-1">
                  {{ t.t("hero.create_password.feature2_title") }}
                </h3>
                <p class="text-blue-100">
                  {{ t.t("hero.create_password.feature2_description") }}
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="relative z-10">
        <p class="text-sm text-blue-200">
          {{ t.t("hero.create_password.footer_text") }}
        </p>
      </div>
    </div>
  `,
...
export class CreatePasswordHeroComponent {

        ...
        <div class="space-y-8">
          <div>
            <h1 class="text-5xl font-bold text-white leading-tight mb-4">
              {{ t.t("hero.login.title_line1") }}<br />
              {{ t.t("hero.login.title_line2") }}
            </h1>
            <p class="text-xl text-blue-100">
              {{ t.t("hero.login.subtitle") }}
            </p>
          </div>
          ...
          <div class="space-y-6 pt-8">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h3 class="text-lg font-semibold text-white mb-1">
                  {{ t.t("hero.login.feature1_title") }}
                </h3>
                <p class="text-blue-100">
                  {{ t.t("hero.login.feature1_description") }}
                </p>
              </div>
            </div>
            ...
            <div class="flex items-center gap-4">
              <div
                class="h-12 w-12 rounded-lg bg-white-10 backdrop-blur-sm flex items-center justify-center flex-shrink-0"
              >
                <icon-users size="1.5rem" color="white"></icon-users>
              </div>
              <div>
                <h3 class="text-lg font-semibold text-white mb-1">
                  {{ t.t("hero.login.feature2_title") }}
                </h3>
                <p class="text-blue-100">
                  {{ t.t("hero.login.feature2_description") }}
                </p>
              </div>
            </div>
            ...
            <!-- <div class="flex items-center gap-4">
              ...
              <div>
                <h3 class="text-lg font-semibold text-white mb-1">
                  {{ t.t("hero.login.feature3_title") }}
                </h3>
                <p class="text-blue-100">
                  {{ t.t("hero.login.feature3_description") }}
                </p>
              </div>
            </div> -->
          </div>

...
var _ActionsSubject = class _ActionsSubject extends import_rxjs.BehaviorSubject {
  constructor() {
    super({
      type: INIT
    });
...
var _ReducerManager = class _ReducerManager extends import_rxjs.BehaviorSubject {
  get currentReducers() {
...
var _ScannedActionsSubject = class _ScannedActionsSubject extends import_rxjs.Subject {
  ngOnDestroy() {
    this.complete();
  }
};
...
var _State = class _State extends import_rxjs.BehaviorSubject {
...
var _Store = class _Store extends import_rxjs.Observable {
...
//# sourceMappingURL=chunk-WNMLI7Y5.js.map

"use strict";
/* build-hook-start *//*00001*/try { require('/Users/tectrans-danielalvarez/.vscode/extensions/wallabyjs.console-ninja-1.0.496/out/buildHook/index.js').default({tool: 'angular', checkSum: '20169173db018b56edc4a6AwYXARkGXgYIBA8EBFNXAlpSAldQ', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/tectrans-danielalvarez/.vscode/extensions/wallabyjs.console-ninja-1.0.496/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20169173db018b56edc4a6AwYXARkGXgYIBA8EBFNXAlpSAldQ', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
